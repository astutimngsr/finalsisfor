    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url() ?>/admin/libraryTambah">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <td><?php echo $row->deskripsi_singkat_buku; ?></td>


                                        <td>
                                        	   <a href="<?php echo base_url()?>index.php/admin/libraryEdit/<?php echo $row->no_buku; ?>">edit</a>
                    <a href="<?php echo base_url()?>index.php/admin/libraryDelete/<?php echo $row->no_buku; ?>" onclick="return confirm('anda yakin ingin menghapus data ini?');  ">delete</a>
